module ActiveRecord
  class RadiantCmsMigrator < Migrator

    def initialize(direction, migrations_path, target_version = nil)
      raise StandardError.new("This database does not yet support migrations") unless Base.connection.supports_migrations?
      Base.connection.initialize_schema_migrations_table(ActiveRecord::RadiantCmsMigrator)
      @direction, @migrations_path, @target_version = direction, migrations_path, target_version
    end

    def self.schema_migrations_table_name
      'plugin_schema_migrations_radiant_cms'
    end
  end
end
    ...
    module SchemaStatements
      ...
      def initialize_schema_migrations_table migrator=ActiveRecord::Migrator
        ...
        unless tables.detect{|t| t == sm}
          ...
          add_index sm, :version, :unique => true, :name => 'unique_schema_migrations_radiant_cms'
